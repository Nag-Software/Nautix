    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Logg inn med Google konto, eller epost.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <FieldDescription className="px-6 text-center">
        Ved å klikke på "Logg inn", godkjenner du våre <a href="https://www.nautix.no/terms">Vilkår for bruk</a>{" "}
        og <a href="https://www.nautix.no/privacy">Personvernerklæring</a>.
      </FieldDescription>
    </div>
  )
}
